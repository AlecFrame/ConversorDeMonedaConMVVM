# ConversorDeMonedaConMVVM
El sistema se ejecuto en un Android 15

Es aplicación sencilla e intuitiva para convertir de dólar a euro o dice versa, tambien se puede cambiar el valor de conversión por uno personalizado.
